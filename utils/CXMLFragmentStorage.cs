...
namespace Trafilm.Gallery
{
  ...
  public class CXMLFragmentStorage<I, T> : ICXMLMetadataStorage<I> where I: ICXMLMetadata where T : ICXMLMetadata, new()
  {
    ...
    public string FragmentsFilter { get; set; } = "*.cxml"; //can be used to select hierarchically named fragments, e.g. "BigBuckBunny.*.cxml" to filter for conversations of film "BigBuckBunny" and "BigBuckBunny.15.*.cxml" to filter for L3SToccurrences of conversation "15" in "BigBuckBunny" film
